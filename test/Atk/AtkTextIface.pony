...
struct AtkTextIface
  ...
  var get_text_after_offset: Pointer[None] = Pointer[None] // PointerType
  var get_text_at_offset: Pointer[None] = Pointer[None] // PointerType
  var get_character_at_offset: Pointer[None] = Pointer[None] // PointerType
  var get_text_before_offset: Pointer[None] = Pointer[None] // PointerType
  var get_caret_offset: Pointer[None] = Pointer[None] // PointerType
  var get_run_attributes: Pointer[None] = Pointer[None] // PointerType
  var get_default_attributes: Pointer[None] = Pointer[None] // PointerType
  var get_character_extents: Pointer[None] = Pointer[None] // PointerType
  var get_character_count: Pointer[None] = Pointer[None] // PointerType
  var get_offset_at_point: Pointer[None] = Pointer[None] // PointerType
  var get_n_selections: Pointer[None] = Pointer[None] // PointerType
  var get_selection: Pointer[None] = Pointer[None] // PointerType
  var add_selection: Pointer[None] = Pointer[None] // PointerType
  var remove_selection: Pointer[None] = Pointer[None] // PointerType
  var set_selection: Pointer[None] = Pointer[None] // PointerType
  var set_caret_offset: Pointer[None] = Pointer[None] // PointerType
  var text_changed: Pointer[None] = Pointer[None] // PointerType
  var text_caret_moved: Pointer[None] = Pointer[None] // PointerType
  var text_selection_changed: Pointer[None] = Pointer[None] // PointerType
  var text_attributes_changed: Pointer[None] = Pointer[None] // PointerType
  var get_range_extents: Pointer[None] = Pointer[None] // PointerType
  var get_bounded_ranges: Pointer[None] = Pointer[None] // PointerType
  var get_string_at_offset: Pointer[None] = Pointer[None] // PointerType
  var scroll_substring_to: Pointer[None] = Pointer[None] // PointerType
  var scroll_substring_to_point: Pointer[None] = Pointer[None] // PointerType
