...
*/
struct GTlsDatabaseClassStruct
  embed parent_class: GObjectClassStruct = GObjectClassStruct // Typedef
  var verify_chain: Pointer[None] = Pointer[None] // PointerType
  var verify_chain_async: Pointer[None] = Pointer[None] // PointerType
  var verify_chain_finish: Pointer[None] = Pointer[None] // PointerType
  var create_certificate_handle: Pointer[None] = Pointer[None] // PointerType
  var lookup_certificate_for_handle: Pointer[None] = Pointer[None] // PointerType
  var lookup_certificate_for_handle_async: Pointer[None] = Pointer[None] // PointerType
  var lookup_certificate_for_handle_finish: Pointer[None] = Pointer[None] // PointerType
  var lookup_certificate_issuer: Pointer[None] = Pointer[None] // PointerType
  var lookup_certificate_issuer_async: Pointer[None] = Pointer[None] // PointerType
  var lookup_certificate_issuer_finish: Pointer[None] = Pointer[None] // PointerType
  var lookup_certificates_issued_by: Pointer[None] = Pointer[None] // PointerType
  var lookup_certificates_issued_by_async: Pointer[None] = Pointer[None] // PointerType
  var lookup_certificates_issued_by_finish: Pointer[None] = Pointer[None] // PointerType
