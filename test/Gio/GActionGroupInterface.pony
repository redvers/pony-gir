...
struct GActionGroupInterface
  ...
  var has_action: Pointer[None] = Pointer[None]
  var list_actions: Pointer[None] = Pointer[None]
  var get_action_enabled: Pointer[None] = Pointer[None]
  var get_action_parameter_type: Pointer[None] = Pointer[None]
  var get_action_state_type: Pointer[None] = Pointer[None]
  var get_action_state_hint: Pointer[None] = Pointer[None]
  var get_action_state: Pointer[None] = Pointer[None]
  var change_action_state: Pointer[None] = Pointer[None]
  var activate_action: Pointer[None] = Pointer[None]
  var action_added: Pointer[None] = Pointer[None]
  var action_removed: Pointer[None] = Pointer[None]
  var action_enabled_changed: Pointer[None] = Pointer[None]
  var action_state_changed: Pointer[None] = Pointer[None]
  var query_action: Pointer[None] = Pointer[None]
