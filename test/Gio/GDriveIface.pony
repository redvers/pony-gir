...
struct GDriveIface
  ...
  var disconnected: Pointer[None] = Pointer[None]
  var eject_button: Pointer[None] = Pointer[None]
  var get_name: Pointer[None] = Pointer[None]
  var get_icon: Pointer[None] = Pointer[None]
  var has_volumes: Pointer[None] = Pointer[None]
  var get_volumes: Pointer[None] = Pointer[None]
  var is_media_removable: Pointer[None] = Pointer[None]
  var has_media: Pointer[None] = Pointer[None]
  var is_media_check_automatic: Pointer[None] = Pointer[None]
  var can_eject: Pointer[None] = Pointer[None]
  var can_poll_for_media: Pointer[None] = Pointer[None]
  var eject: Pointer[None] = Pointer[None]
  var eject_finish: Pointer[None] = Pointer[None]
  var poll_for_media: Pointer[None] = Pointer[None]
  var poll_for_media_finish: Pointer[None] = Pointer[None]
  var get_identifier: Pointer[None] = Pointer[None]
  var enumerate_identifiers: Pointer[None] = Pointer[None]
  var get_start_stop_type: Pointer[None] = Pointer[None]
  var can_start: Pointer[None] = Pointer[None]
  var can_start_degraded: Pointer[None] = Pointer[None]
  var start: Pointer[None] = Pointer[None]
  var start_finish: Pointer[None] = Pointer[None]
  var can_stop: Pointer[None] = Pointer[None]
  var stop: Pointer[None] = Pointer[None]
  var stop_finish: Pointer[None] = Pointer[None]
  var stop_button: Pointer[None] = Pointer[None]
  ...
  var is_removable: Pointer[None] = Pointer[None]
