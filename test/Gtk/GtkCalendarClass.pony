...
struct GtkCalendarClass
  ...
  var month_changed: Pointer[None] = Pointer[None]
  var day_selected: Pointer[None] = Pointer[None]
  var day_selected_double_click: Pointer[None] = Pointer[None]
  var prev_month: Pointer[None] = Pointer[None]
  var next_month: Pointer[None] = Pointer[None]
  var prev_year: Pointer[None] = Pointer[None]
  var next_year: Pointer[None] = Pointer[None]
