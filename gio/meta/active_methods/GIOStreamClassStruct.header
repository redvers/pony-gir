...
*/
struct GIOStreamClassStruct
  embed parent_class: GObjectClassStruct = GObjectClassStruct // Typedef
  var get_input_stream: Pointer[None] = Pointer[None] // PointerType
  var get_output_stream: Pointer[None] = Pointer[None] // PointerType
  ...
  var _g_reserved10: Pointer[None] = Pointer[None] // PointerType
