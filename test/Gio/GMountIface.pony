...
struct GMountIface
  ...
  var unmounted: Pointer[None] = Pointer[None]
  ...
  var get_volume: Pointer[None] = Pointer[None]
  var get_drive: Pointer[None] = Pointer[None]
  var can_unmount: Pointer[None] = Pointer[None]
  var can_eject: Pointer[None] = Pointer[None]
  var unmount: Pointer[None] = Pointer[None]
  var unmount_finish: Pointer[None] = Pointer[None]
  var eject: Pointer[None] = Pointer[None]
  var eject_finish: Pointer[None] = Pointer[None]
  var remount: Pointer[None] = Pointer[None]
  var remount_finish: Pointer[None] = Pointer[None]
  var guess_content_type: Pointer[None] = Pointer[None]
  var guess_content_type_finish: Pointer[None] = Pointer[None]
  var guess_content_type_sync: Pointer[None] = Pointer[None]
  var pre_unmount: Pointer[None] = Pointer[None]
  var unmount_with_operation: Pointer[None] = Pointer[None]
  var unmount_with_operation_finish: Pointer[None] = Pointer[None]
  var eject_with_operation: Pointer[None] = Pointer[None]
  var eject_with_operation_finish: Pointer[None] = Pointer[None]
  var get_default_location: Pointer[None] = Pointer[None]
