...
primitive GType
  ...
  fun query(gtype: U64, query': NullablePointer[GTypeQuery] tag): None =>
    @g_type_query(gtype, query')

  fun get_instance_count(gtype: U64): I32 =>
    @g_type_get_instance_count(gtype)

  fun register_static(parenttype: U64, typename: String, info: NullablePointer[GTypeInfo] tag, flags: I32): U64 =>
  ...
  fun register_dynamic(parenttype: U64, typename: String, plugin: GTypePlugin tag, flags: I32): U64 =>
    @g_type_register_dynamic(parenttype, typename.cstring(), plugin, flags)

  fun register_fundamental(typeid: U64, typename: String, info: NullablePointer[GTypeInfo] tag, finfo: NullablePointer[GTypeFundamentalInfo] tag, flags: I32): U64 =>
    @g_type_register_fundamental(typeid, typename.cstring(), info, finfo, flags)

  fun add_interface_static(instancetype: U64, interfacetype: U64, info: NullablePointer[GInterfaceInfo] tag): None =>
    @g_type_add_interface_static(instancetype, interfacetype, info)

  fun add_interface_dynamic(instancetype: U64, interfacetype: U64, plugin: GTypePlugin tag): None =>
  ...
  fun instance_get_private(instance: NullablePointer[GTypeInstance] tag, privatetype: U64): Pointer[None] =>
  ...
  fun get_plugin(gtype: U64): GTypePlugin =>
  ...
  fun create_instance(gtype: U64): NullablePointer[GTypeInstance] =>
    @g_type_create_instance(gtype)

  fun free_instance(instance: NullablePointer[GTypeInstance] tag): None =>
  ...
  fun value_table_peek(gtype: U64): NullablePointer[GTypeValueTable] =>
    @g_type_value_table_peek(gtype)

  fun check_instance(instance: NullablePointer[GTypeInstance] tag): I32 =>
    @g_type_check_instance(instance)

  fun check_instance_cast(instance: NullablePointer[GTypeInstance] tag, ifacetype: U64): NullablePointer[GTypeInstance] =>
    @g_type_check_instance_cast(instance, ifacetype)

  fun check_instance_is_a(instance: NullablePointer[GTypeInstance] tag, ifacetype: U64): I32 =>
    @g_type_check_instance_is_a(instance, ifacetype)

  fun check_instance_is_fundamentally_a(instance: NullablePointer[GTypeInstance] tag, fundamentaltype: U64): I32 =>
    @g_type_check_instance_is_fundamentally_a(instance, fundamentaltype)

  fun check_class_cast(gclass: GTypeClass tag, isatype: U64): GTypeClass =>
    @g_type_check_class_cast(gclass, isatype)

  fun check_class_is_a(gclass: GTypeClass tag, isatype: U64): I32 =>
    @g_type_check_class_is_a(gclass, isatype)

  fun check_is_value_type(gtype: U64): I32 =>
    @g_type_check_is_value_type(gtype)

  fun check_value(value: GValue tag): I32 =>
    @g_type_check_value(value)

  fun check_value_holds(value: GValue tag, gtype: U64): I32 =>
    @g_type_check_value_holds(value, gtype)

  fun test_flags(gtype: U64, flags: U32): I32 =>
    @g_type_test_flags(gtype, flags)

  fun name_from_instance(instance: NullablePointer[GTypeInstance] tag): String =>
    var pcstring: Pointer[U8] =  @g_type_name_from_instance(instance)
    let p: String iso = String.from_cstring(pcstring).clone()
    consume p

  fun name_from_class(gclass: GTypeClass tag): String =>
