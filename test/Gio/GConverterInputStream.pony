...
struct GConverterInputStream
  embed parent_instance: GFilterInputStream = GFilterInputStream // Typedef
  var priv: NullablePointer[GConverterInputStreamPrivate] = NullablePointer[GConverterInputStreamPrivate].none() // PointerType
