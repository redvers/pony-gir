...
*/
struct GtkCellViewStruct
  embed parent_instance: GtkWidgetStruct = GtkWidgetStruct // Typedef
  var priv: GtkCellViewPrivateStruct = GtkCellViewPrivateStruct // PointerType
