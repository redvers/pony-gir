...
*/
struct GFileOutputStreamClassStruct
  embed parent_class: GOutputStreamClassStruct = GOutputStreamClassStruct // Typedef
  ...
  var get_etag: Pointer[None] = Pointer[None] // PointerType
