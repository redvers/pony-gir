...
*/
struct GtkTreeViewStruct
  embed parent: GtkContainerStruct = GtkContainerStruct // Typedef
  var priv: GtkTreeViewPrivateStruct = GtkTreeViewPrivateStruct // PointerType
