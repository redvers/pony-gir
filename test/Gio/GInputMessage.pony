...
struct GInputMessage
  var address: Array[NullablePointer[GSocketAddress]] = Array[NullablePointer[GSocketAddress]]
  ...
  var flags: I32 = I32(0)
  var control_messages: Pointer[Pointer[NullablePointer[GSocketControlMessage]]] = Pointer[Pointer[NullablePointer[GSocketControlMessage]]]
