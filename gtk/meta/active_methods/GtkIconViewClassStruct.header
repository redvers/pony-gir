...
struct GtkIconViewClassStruct
  ...
  var select_cursor_item: Pointer[None] = Pointer[None] // PointerType
  var toggle_cursor_item: Pointer[None] = Pointer[None] // PointerType
  var move_cursor: Pointer[None] = Pointer[None] // PointerType
  var activate_cursor_item: Pointer[None] = Pointer[None] // PointerType
