...
struct GSocketControlMessageClass
  ...
  var get_level: Pointer[None] = Pointer[None]
  var get_type: Pointer[None] = Pointer[None]
  var serialize: Pointer[None] = Pointer[None]
  var deserialize: Pointer[None] = Pointer[None]
