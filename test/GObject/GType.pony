...
use @g_type_add_interface_static[None](instancetype: U64, interfacetype: U64, info: GInterfaceInfoStruct tag)
...
use @g_type_check_instance[I32](instance: GTypeInstanceStruct tag)
use @g_type_check_instance_cast[GTypeInstanceStruct](instance: GTypeInstanceStruct tag, ifacetype: U64)
use @g_type_check_instance_is_a[I32](instance: GTypeInstanceStruct tag, ifacetype: U64)
use @g_type_check_instance_is_fundamentally_a[I32](instance: GTypeInstanceStruct tag, fundamentaltype: U64)
...
use @g_type_create_instance[GTypeInstanceStruct](gtype: U64)
...
use @g_type_free_instance[None](instance: GTypeInstanceStruct tag)
...
use @g_type_instance_get_private[Pointer[None]](instance: GTypeInstanceStruct tag, privatetype: U64)
...
use @g_type_name_from_instance[Pointer[U8]](instance: GTypeInstanceStruct tag)
use @g_type_next_base[U64](leaftype: U64, roottype: U64)
use @g_type_parent[U64](gtype: U64)
use @g_type_qname[U32](gtype: U64)
use @g_type_query[None](gtype: U64, query': GTypeQueryStruct tag)
use @g_type_register_dynamic[U64](parenttype: U64, typename: Pointer[U8] tag, plugin: GTypePluginStruct tag, flags: I32)
use @g_type_register_fundamental[U64](typeid: U64, typename: Pointer[U8] tag, info: GTypeInfoStruct tag, finfo: GTypeFundamentalInfoStruct tag, flags: I32)
use @g_type_register_static[U64](parenttype: U64, typename: Pointer[U8] tag, info: GTypeInfoStruct tag, flags: I32)
...
use @g_type_value_table_peek[GTypeValueTableStruct](gtype: U64)
...
primitive GType
  ...
  fun query(gtype: U64, query': GTypeQueryStruct tag): None =>
    @g_type_query(gtype, query')

  fun get_instance_count(gtype: U64): I32 =>
    @g_type_get_instance_count(gtype)

  fun register_static(parenttype: U64, typename: String, info: GTypeInfoStruct tag, flags: I32): U64 =>
  ...
  fun register_fundamental(typeid: U64, typename: String, info: GTypeInfoStruct tag, finfo: GTypeFundamentalInfoStruct tag, flags: I32): U64 =>
    @g_type_register_fundamental(typeid, typename.cstring(), info, finfo, flags)

  fun add_interface_static(instancetype: U64, interfacetype: U64, info: GInterfaceInfoStruct tag): None =>
  ...
  fun instance_get_private(instance: GTypeInstanceStruct tag, privatetype: U64): Pointer[None] =>
  ...
  fun create_instance(gtype: U64): GTypeInstanceStruct =>
    @g_type_create_instance(gtype)

  fun free_instance(instance: GTypeInstanceStruct tag): None =>
  ...
  fun value_table_peek(gtype: U64): GTypeValueTableStruct =>
    @g_type_value_table_peek(gtype)

  fun check_instance(instance: GTypeInstanceStruct tag): I32 =>
    @g_type_check_instance(instance)

  fun check_instance_cast(instance: GTypeInstanceStruct tag, ifacetype: U64): GTypeInstanceStruct =>
    @g_type_check_instance_cast(instance, ifacetype)

  fun check_instance_is_a(instance: GTypeInstanceStruct tag, ifacetype: U64): I32 =>
    @g_type_check_instance_is_a(instance, ifacetype)

  fun check_instance_is_fundamentally_a(instance: GTypeInstanceStruct tag, fundamentaltype: U64): I32 =>
  ...
  fun name_from_instance(instance: GTypeInstanceStruct tag): String =>
