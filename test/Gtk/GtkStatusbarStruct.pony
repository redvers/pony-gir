...
*/
struct GtkStatusbarStruct
  embed parent_widget: GtkBoxStruct = GtkBoxStruct // Typedef
  var priv: GtkStatusbarPrivateStruct = GtkStatusbarPrivateStruct // PointerType
