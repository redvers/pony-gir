...
*/
struct GtkBindingEntryStruct
  var keyval: U32 = U32(0) // Typedef
  var modifiers: I32 = I32(0) // Typedef
  var binding_set: GtkBindingSetStruct = GtkBindingSetStruct // PointerType
  var destroyed: U32 = U32(0) // Typedef
  var in_emission: U32 = U32(0) // Typedef
  var marks_unbound: U32 = U32(0) // Typedef
  var set_next: GtkBindingEntryStruct = GtkBindingEntryStruct // PointerType
  var hash_next: GtkBindingEntryStruct = GtkBindingEntryStruct // PointerType
  var signals: GtkBindingSignalStruct = GtkBindingSignalStruct // PointerType
