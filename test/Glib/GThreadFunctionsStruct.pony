...
*/
struct GThreadFunctionsStruct
  var mutex_new: Pointer[None] = Pointer[None] // PointerType
  var mutex_lock: Pointer[None] = Pointer[None] // PointerType
  var mutex_trylock: Pointer[None] = Pointer[None] // PointerType
  var mutex_unlock: Pointer[None] = Pointer[None] // PointerType
  var mutex_free: Pointer[None] = Pointer[None] // PointerType
  var cond_new: Pointer[None] = Pointer[None] // PointerType
  var cond_signal: Pointer[None] = Pointer[None] // PointerType
  var cond_broadcast: Pointer[None] = Pointer[None] // PointerType
  var cond_wait: Pointer[None] = Pointer[None] // PointerType
  var cond_timed_wait: Pointer[None] = Pointer[None] // PointerType
  var cond_free: Pointer[None] = Pointer[None] // PointerType
  var private_new: Pointer[None] = Pointer[None] // PointerType
  var private_get: Pointer[None] = Pointer[None] // PointerType
  var private_set: Pointer[None] = Pointer[None] // PointerType
  var thread_create: Pointer[None] = Pointer[None] // PointerType
  var thread_yield: Pointer[None] = Pointer[None] // PointerType
  var thread_join: Pointer[None] = Pointer[None] // PointerType
  var thread_exit: Pointer[None] = Pointer[None] // PointerType
  var thread_set_priority: Pointer[None] = Pointer[None] // PointerType
  var thread_self: Pointer[None] = Pointer[None] // PointerType
  var thread_equal: Pointer[None] = Pointer[None] // PointerType
