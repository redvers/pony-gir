...
*/
struct GtkRecentChooserMenuStruct
  embed parent_instance: GtkMenuStruct = GtkMenuStruct // Typedef
  var priv: GtkRecentChooserMenuPrivateStruct = GtkRecentChooserMenuPrivateStruct // PointerType
