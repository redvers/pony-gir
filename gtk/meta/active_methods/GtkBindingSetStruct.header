...
*/
struct GtkBindingSetStruct
  var set_name: Pointer[U8] = Pointer[U8] // PointerType
  var priority: I32 = I32(0) // Typedef
  var widget_path_pspecs: GSListStruct = GSListStruct // PointerType
  var widget_class_pspecs: GSListStruct = GSListStruct // PointerType
  var class_branch_pspecs: GSListStruct = GSListStruct // PointerType
  var entries: GtkBindingEntryStruct = GtkBindingEntryStruct // PointerType
  var current: GtkBindingEntryStruct = GtkBindingEntryStruct // PointerType
