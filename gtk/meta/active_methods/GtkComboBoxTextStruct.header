...
*/
struct GtkComboBoxTextStruct
  embed parent_instance: GtkComboBoxStruct = GtkComboBoxStruct // Typedef
  var priv: GtkComboBoxTextPrivateStruct = GtkComboBoxTextPrivateStruct // PointerType
