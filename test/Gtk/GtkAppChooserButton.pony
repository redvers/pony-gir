...
struct GtkAppChooserButton
  embed parent: GtkComboBox = GtkComboBox // Typedef
  var priv: NullablePointer[GtkAppChooserButtonPrivate] = NullablePointer[GtkAppChooserButtonPrivate].none() // PointerType
