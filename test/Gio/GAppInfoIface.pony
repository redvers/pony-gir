...
struct GAppInfoIface
  ...
  var get_executable: Pointer[None] = Pointer[None]
  var get_icon: Pointer[None] = Pointer[None]
  var launch: Pointer[None] = Pointer[None]
  var supports_uris: Pointer[None] = Pointer[None]
  var supports_files: Pointer[None] = Pointer[None]
  var launch_uris: Pointer[None] = Pointer[None]
  var should_show: Pointer[None] = Pointer[None]
  var set_as_default_for_type: Pointer[None] = Pointer[None]
  var set_as_default_for_extension: Pointer[None] = Pointer[None]
  var add_supports_type: Pointer[None] = Pointer[None]
  var can_remove_supports_type: Pointer[None] = Pointer[None]
  var remove_supports_type: Pointer[None] = Pointer[None]
  var can_delete: Pointer[None] = Pointer[None]
  var do_delete: Pointer[None] = Pointer[None]
  var get_commandline: Pointer[None] = Pointer[None]
  var get_display_name: Pointer[None] = Pointer[None]
  var set_as_last_used_for_type: Pointer[None] = Pointer[None]
  var get_supported_types: Pointer[None] = Pointer[None]
  var launch_uris_async: Pointer[None] = Pointer[None]
  var launch_uris_finish: Pointer[None] = Pointer[None]
