...
struct GThreadFunctions
  var mutex_new: Pointer[None] = Pointer[None]
  var mutex_lock: Pointer[None] = Pointer[None]
  var mutex_trylock: Pointer[None] = Pointer[None]
  var mutex_unlock: Pointer[None] = Pointer[None]
  var mutex_free: Pointer[None] = Pointer[None]
  var cond_new: Pointer[None] = Pointer[None]
  var cond_signal: Pointer[None] = Pointer[None]
  var cond_broadcast: Pointer[None] = Pointer[None]
  var cond_wait: Pointer[None] = Pointer[None]
  var cond_timed_wait: Pointer[None] = Pointer[None]
  var cond_free: Pointer[None] = Pointer[None]
  var private_new: Pointer[None] = Pointer[None]
  var private_get: Pointer[None] = Pointer[None]
  var private_set: Pointer[None] = Pointer[None]
  var thread_create: Pointer[None] = Pointer[None]
  var thread_yield: Pointer[None] = Pointer[None]
  var thread_join: Pointer[None] = Pointer[None]
  var thread_exit: Pointer[None] = Pointer[None]
  var thread_set_priority: Pointer[None] = Pointer[None]
  var thread_self: Pointer[None] = Pointer[None]
  var thread_equal: Pointer[None] = Pointer[None]
