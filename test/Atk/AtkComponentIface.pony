...
struct AtkComponentIface
  ...
  var add_focus_handler: Pointer[None] = Pointer[None]
  var contains: Pointer[None] = Pointer[None]
  var ref_accessible_at_point: Pointer[None] = Pointer[None]
  var get_extents: Pointer[None] = Pointer[None]
  var get_position: Pointer[None] = Pointer[None]
  var get_size: Pointer[None] = Pointer[None]
  var grab_focus: Pointer[None] = Pointer[None]
  var remove_focus_handler: Pointer[None] = Pointer[None]
  var set_extents: Pointer[None] = Pointer[None]
  var set_position: Pointer[None] = Pointer[None]
  var set_size: Pointer[None] = Pointer[None]
  var get_layer: Pointer[None] = Pointer[None]
  var get_mdi_zorder: Pointer[None] = Pointer[None]
  var bounds_changed: Pointer[None] = Pointer[None]
  var get_alpha: Pointer[None] = Pointer[None]
  var scroll_to: Pointer[None] = Pointer[None]
  var scroll_to_point: Pointer[None] = Pointer[None]
