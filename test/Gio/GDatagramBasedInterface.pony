...
struct GDatagramBasedInterface
  ...
  var receive_messages: Pointer[None] = Pointer[None]
  var send_messages: Pointer[None] = Pointer[None]
  var create_source: Pointer[None] = Pointer[None]
  var condition_check: Pointer[None] = Pointer[None]
  var condition_wait: Pointer[None] = Pointer[None]
