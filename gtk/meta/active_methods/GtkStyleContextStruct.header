...
*/
struct GtkStyleContextStruct
  embed parent_object: GObjectStruct = GObjectStruct // Typedef
  var priv: GtkStyleContextPrivateStruct = GtkStyleContextPrivateStruct // PointerType
