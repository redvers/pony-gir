...
*/  fun new_with_properties(objecttype: U64, nproperties: U32, names: Pointer[Pointer[U8]], values: GValue tag): GObject =>
  ...
  fun type_cclosure_new(itype: U64, structoffset: U32): NullablePointer[GClosure] =>
    @g_signal_type_cclosure_new(itype, structoffset)

  fun newv(signalname: String, itype: U64, signalflags: I32, classclosure: NullablePointer[GClosure] tag, accumulator: Pointer[None] tag, accudata: Pointer[None] tag, cmarshaller: Pointer[None] tag, returntype: U64, nparams: U32, paramtypes: Pointer[U64] tag): U32 =>
...
*/
  fun emitv(instanceandparams: GValue tag, signalid: U32, detail: U32, returnvalue: GValue tag): None =>
...
*/
  ...
  fun query(signalid: U32, query': NullablePointer[GSignalQuery] tag): None =>
  ...
  fun get_invocation_hint(instance: Pointer[None] tag): NullablePointer[GSignalInvocationHint] =>
  ...
  fun connect_closure_by_id(instance: Pointer[None] tag, signalid: U32, detail: U32, closure: NullablePointer[GClosure] tag, after: I32): U64 =>
  ...
  fun handler_find(instance: Pointer[None] tag, mask: I32, signalid: U32, detail: U32, closure: NullablePointer[GClosure] tag, func: Pointer[None] tag, data: Pointer[None] tag): U64 =>
    @g_signal_handler_find(instance, mask, signalid, detail, closure, func, data)

  fun handlers_block_matched(instance: Pointer[None] tag, mask: I32, signalid: U32, detail: U32, closure: NullablePointer[GClosure] tag, func: Pointer[None] tag, data: Pointer[None] tag): U32 =>
    @g_signal_handlers_block_matched(instance, mask, signalid, detail, closure, func, data)

  fun handlers_unblock_matched(instance: Pointer[None] tag, mask: I32, signalid: U32, detail: U32, closure: NullablePointer[GClosure] tag, func: Pointer[None] tag, data: Pointer[None] tag): U32 =>
    @g_signal_handlers_unblock_matched(instance, mask, signalid, detail, closure, func, data)

  fun handlers_disconnect_matched(instance: Pointer[None] tag, mask: I32, signalid: U32, detail: U32, closure: NullablePointer[GClosure] tag, func: Pointer[None] tag, data: Pointer[None] tag): U32 =>
    @g_signal_handlers_disconnect_matched(instance, mask, signalid, detail, closure, func, data)

  fun override_class_closure(signalid: U32, instancetype: U64, classclosure: NullablePointer[GClosure] tag): None =>
  ...
  fun chain_from_overridden(instanceandparams: GValue tag, returnvalue: GValue tag): None =>
...
*/
  fun accumulator_true_handled(ihint: NullablePointer[GSignalInvocationHint] tag, returnaccu: GValue tag, handlerreturn: GValue tag, dummy: Pointer[None] tag): I32 =>
    @g_signal_accumulator_true_handled(ihint, returnaccu, handlerreturn, dummy)

  fun accumulator_first_wins(ihint: NullablePointer[GSignalInvocationHint] tag, returnaccu: GValue tag, handlerreturn: GValue tag, dummy: Pointer[None] tag): I32 =>
