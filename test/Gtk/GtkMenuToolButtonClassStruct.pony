...
*/
struct GtkMenuToolButtonClassStruct
  embed parent_class: GtkToolButtonClassStruct = GtkToolButtonClassStruct // Typedef
  var show_menu: Pointer[None] = Pointer[None] // PointerType
