...
struct GTcpWrapperConnection
  embed parent_instance: GTcpConnection = GTcpConnection // Typedef
  var priv: NullablePointer[GTcpWrapperConnectionPrivate] = NullablePointer[GTcpWrapperConnectionPrivate].none() // PointerType
