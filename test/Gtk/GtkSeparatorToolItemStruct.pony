...
*/
struct GtkSeparatorToolItemStruct
  embed parent: GtkToolItemStruct = GtkToolItemStruct // Typedef
  var priv: GtkSeparatorToolItemPrivateStruct = GtkSeparatorToolItemPrivateStruct // PointerType
