...
struct AtkObjectClass
  ...
  var get_n_children: Pointer[None] = Pointer[None]
  var ref_child: Pointer[None] = Pointer[None]
  var get_index_in_parent: Pointer[None] = Pointer[None]
  var ref_relation_set: Pointer[None] = Pointer[None]
  var get_role: Pointer[None] = Pointer[None]
  var get_layer: Pointer[None] = Pointer[None]
  var get_mdi_zorder: Pointer[None] = Pointer[None]
  var ref_state_set: Pointer[None] = Pointer[None]
  var set_name: Pointer[None] = Pointer[None]
  var set_description: Pointer[None] = Pointer[None]
  var set_parent: Pointer[None] = Pointer[None]
  var set_role: Pointer[None] = Pointer[None]
  var connect_property_change_handler: Pointer[None] = Pointer[None]
  var remove_property_change_handler: Pointer[None] = Pointer[None]
  var initialize: Pointer[None] = Pointer[None]
  var children_changed: Pointer[None] = Pointer[None]
  var focus_event: Pointer[None] = Pointer[None]
  var property_change: Pointer[None] = Pointer[None]
  var state_change: Pointer[None] = Pointer[None]
  var visible_data_changed: Pointer[None] = Pointer[None]
  var active_descendant_changed: Pointer[None] = Pointer[None]
  var get_attributes: Pointer[None] = Pointer[None]
  var get_object_locale: Pointer[None] = Pointer[None]
