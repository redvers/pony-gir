...
struct GVfsClass
  ...
  var is_active: Pointer[None] = Pointer[None]
  var get_file_for_path: Pointer[None] = Pointer[None]
  var get_file_for_uri: Pointer[None] = Pointer[None]
  var get_supported_uri_schemes: Pointer[None] = Pointer[None]
  var parse_name: Pointer[None] = Pointer[None]
  var local_file_add_info: Pointer[None] = Pointer[None]
  var add_writable_namespaces: Pointer[None] = Pointer[None]
  var local_file_set_attributes: Pointer[None] = Pointer[None]
  var local_file_removed: Pointer[None] = Pointer[None]
  var local_file_moved: Pointer[None] = Pointer[None]
  var deserialize_icon: Pointer[None] = Pointer[None]
