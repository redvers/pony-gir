...
struct GProxyAddress
  embed parent_instance: GInetSocketAddress = GInetSocketAddress // Typedef
  var priv: NullablePointer[GProxyAddressPrivate] = NullablePointer[GProxyAddressPrivate].none() // PointerType
