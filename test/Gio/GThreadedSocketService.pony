...
struct GThreadedSocketService
  embed parent_instance: GSocketService = GSocketService // Typedef
  var priv: NullablePointer[GThreadedSocketServicePrivate] = NullablePointer[GThreadedSocketServicePrivate].none() // PointerType
