...
/*
  Source: headers/glib-2.70.1/glib-2.0/gio/gresolver.h:63
...
struct GResolverClass
  ...
  var reload: Pointer[None] = Pointer[None] // PointerType
  var lookup_by_name: Pointer[None] = Pointer[None] // PointerType
  var lookup_by_name_async: Pointer[None] = Pointer[None] // PointerType
  var lookup_by_name_finish: Pointer[None] = Pointer[None] // PointerType
  var lookup_by_address: Pointer[None] = Pointer[None] // PointerType
  var lookup_by_address_async: Pointer[None] = Pointer[None] // PointerType
  var lookup_by_address_finish: Pointer[None] = Pointer[None] // PointerType
  var lookup_service: Pointer[None] = Pointer[None] // PointerType
  var lookup_service_async: Pointer[None] = Pointer[None] // PointerType
  var lookup_service_finish: Pointer[None] = Pointer[None] // PointerType
  var lookup_records: Pointer[None] = Pointer[None] // PointerType
  var lookup_records_async: Pointer[None] = Pointer[None] // PointerType
  var lookup_records_finish: Pointer[None] = Pointer[None] // PointerType
  var lookup_by_name_with_flags_async: Pointer[None] = Pointer[None] // PointerType
  var lookup_by_name_with_flags_finish: Pointer[None] = Pointer[None] // PointerType
  var lookup_by_name_with_flags: Pointer[None] = Pointer[None] // PointerType
