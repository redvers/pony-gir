...
struct GTcpConnection
  embed parent_instance: GSocketConnection = GSocketConnection // Typedef
  var priv: NullablePointer[GTcpConnectionPrivate] = NullablePointer[GTcpConnectionPrivate].none() // PointerType
