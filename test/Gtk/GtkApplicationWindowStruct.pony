...
*/
struct GtkApplicationWindowStruct
  embed parent_instance: GtkWindowStruct = GtkWindowStruct // Typedef
  var priv: GtkApplicationWindowPrivateStruct = GtkApplicationWindowPrivateStruct // PointerType
