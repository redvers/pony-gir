...
struct GtkWidgetClass
  ...
  var activate_signal: U32 = U32(0)
  var dispatch_child_properties_changed: Pointer[None] = Pointer[None]
  var destroy: Pointer[None] = Pointer[None]
  var show: Pointer[None] = Pointer[None]
  var show_all: Pointer[None] = Pointer[None]
  ...
  var state_changed: Pointer[None] = Pointer[None]
  var state_flags_changed: Pointer[None] = Pointer[None]
  var parent_set: Pointer[None] = Pointer[None]
  var hierarchy_changed: Pointer[None] = Pointer[None]
  var style_set: Pointer[None] = Pointer[None]
  var direction_changed: Pointer[None] = Pointer[None]
  var grab_notify: Pointer[None] = Pointer[None]
  var child_notify: Pointer[None] = Pointer[None]
  var draw: Pointer[None] = Pointer[None]
  ...
  var button_press_event: Pointer[None] = Pointer[None]
  var button_release_event: Pointer[None] = Pointer[None]
  var scroll_event: Pointer[None] = Pointer[None]
  var motion_notify_event: Pointer[None] = Pointer[None]
  var delete_event: Pointer[None] = Pointer[None]
  var destroy_event: Pointer[None] = Pointer[None]
  var key_press_event: Pointer[None] = Pointer[None]
  var key_release_event: Pointer[None] = Pointer[None]
  var enter_notify_event: Pointer[None] = Pointer[None]
  var leave_notify_event: Pointer[None] = Pointer[None]
  var configure_event: Pointer[None] = Pointer[None]
  var focus_in_event: Pointer[None] = Pointer[None]
  var focus_out_event: Pointer[None] = Pointer[None]
  var map_event: Pointer[None] = Pointer[None]
  var unmap_event: Pointer[None] = Pointer[None]
  var property_notify_event: Pointer[None] = Pointer[None]
  var selection_clear_event: Pointer[None] = Pointer[None]
  var selection_request_event: Pointer[None] = Pointer[None]
  var selection_notify_event: Pointer[None] = Pointer[None]
  var proximity_in_event: Pointer[None] = Pointer[None]
  var proximity_out_event: Pointer[None] = Pointer[None]
  var visibility_notify_event: Pointer[None] = Pointer[None]
  var window_state_event: Pointer[None] = Pointer[None]
  var damage_event: Pointer[None] = Pointer[None]
  var grab_broken_event: Pointer[None] = Pointer[None]
  var selection_get: Pointer[None] = Pointer[None]
  var selection_received: Pointer[None] = Pointer[None]
  var drag_begin: Pointer[None] = Pointer[None]
  var drag_end: Pointer[None] = Pointer[None]
  var drag_data_get: Pointer[None] = Pointer[None]
  var drag_data_delete: Pointer[None] = Pointer[None]
  var drag_leave: Pointer[None] = Pointer[None]
  var drag_motion: Pointer[None] = Pointer[None]
  var drag_drop: Pointer[None] = Pointer[None]
  var drag_data_received: Pointer[None] = Pointer[None]
  var drag_failed: Pointer[None] = Pointer[None]
  var popup_menu: Pointer[None] = Pointer[None]
  var show_help: Pointer[None] = Pointer[None]
  var get_accessible: Pointer[None] = Pointer[None]
  var screen_changed: Pointer[None] = Pointer[None]
  var can_activate_accel: Pointer[None] = Pointer[None]
  var composited_changed: Pointer[None] = Pointer[None]
  var query_tooltip: Pointer[None] = Pointer[None]
  var compute_expand: Pointer[None] = Pointer[None]
  var adjust_size_request: Pointer[None] = Pointer[None]
  var adjust_size_allocation: Pointer[None] = Pointer[None]
  var style_updated: Pointer[None] = Pointer[None]
  var touch_event: Pointer[None] = Pointer[None]
  var get_preferred_height_and_baseline_for_width: Pointer[None] = Pointer[None]
  var adjust_baseline_request: Pointer[None] = Pointer[None]
  var adjust_baseline_allocation: Pointer[None] = Pointer[None]
  var queue_draw_region: Pointer[None] = Pointer[None]
