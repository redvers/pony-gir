...
struct GObjectStruct
  ...
  fun type_cclosure_new(itype: U64, structoffset: U32): GClosureStruct =>
    @g_signal_type_cclosure_new(itype, structoffset)

  fun newv(signalname: String, itype: U64, signalflags: I32, classclosure: GClosureStruct tag, accumulator: Pointer[None] tag, accudata: Pointer[None] tag, cmarshaller: Pointer[None] tag, returntype: U64, nparams: U32, paramtypes: Pointer[U64] tag): U32 =>
...
*/
  ...
  fun query(signalid: U32, query': GSignalQueryStruct tag): None =>
  ...
  fun get_invocation_hint(instance: Pointer[None] tag): GSignalInvocationHintStruct =>
  ...
  fun connect_closure_by_id(instance: Pointer[None] tag, signalid: U32, detail: U32, closure: GClosureStruct tag, after: I32): U64 =>
    @g_signal_connect_closure_by_id(instance, signalid, detail, closure, after)

  fun connect_closure(instance: Pointer[None] tag, detailedsignal: String, closure: GClosureStruct tag, after: I32): U64 =>
  ...
  fun handler_find(instance: Pointer[None] tag, mask: I32, signalid: U32, detail: U32, closure: GClosureStruct tag, func: Pointer[None] tag, data: Pointer[None] tag): U64 =>
    @g_signal_handler_find(instance, mask, signalid, detail, closure, func, data)

  fun handlers_block_matched(instance: Pointer[None] tag, mask: I32, signalid: U32, detail: U32, closure: GClosureStruct tag, func: Pointer[None] tag, data: Pointer[None] tag): U32 =>
    @g_signal_handlers_block_matched(instance, mask, signalid, detail, closure, func, data)

  fun handlers_unblock_matched(instance: Pointer[None] tag, mask: I32, signalid: U32, detail: U32, closure: GClosureStruct tag, func: Pointer[None] tag, data: Pointer[None] tag): U32 =>
    @g_signal_handlers_unblock_matched(instance, mask, signalid, detail, closure, func, data)

  fun handlers_disconnect_matched(instance: Pointer[None] tag, mask: I32, signalid: U32, detail: U32, closure: GClosureStruct tag, func: Pointer[None] tag, data: Pointer[None] tag): U32 =>
    @g_signal_handlers_disconnect_matched(instance, mask, signalid, detail, closure, func, data)

  fun override_class_closure(signalid: U32, instancetype: U64, classclosure: GClosureStruct tag): None =>
...
*/
  fun accumulator_true_handled(ihint: GSignalInvocationHintStruct tag, returnaccu: GValueStruct tag, handlerreturn: GValueStruct tag, dummy: Pointer[None] tag): I32 =>
    @g_signal_accumulator_true_handled(ihint, returnaccu, handlerreturn, dummy)

  fun accumulator_first_wins(ihint: GSignalInvocationHintStruct tag, returnaccu: GValueStruct tag, handlerreturn: GValueStruct tag, dummy: Pointer[None] tag): I32 =>
...
*/
  ...
  fun notify_by_pspec(pspec: GParamSpecStruct tag): None =>
  ...
  fun add_weak_pointer(weakpointerlocation: Pointer[None] tag): None =>
    @g_object_add_weak_pointer(this, weakpointerlocation)

  fun remove_weak_pointer(weakpointerlocation: Pointer[None] tag): None =>
  ...
  fun replace_qdata(quark: U32, oldval: Pointer[None] tag, newval: Pointer[None] tag, destroy: Pointer[None] tag, olddestroy: Pointer[None] tag): I32 =>
  ...
  fun replace_data(key: String, oldval: Pointer[None] tag, newval: Pointer[None] tag, destroy: Pointer[None] tag, olddestroy: Pointer[None] tag): I32 =>
    @g_object_replace_data(this, key.cstring(), oldval, newval, destroy, olddestroy)

  fun watch_closure(closure: GClosureStruct tag): None =>
  ...
  fun bind_property(source: Pointer[None] tag, sourceproperty: String, target: Pointer[None] tag, targetproperty: String, flags: I32): GBindingStruct =>
    @g_object_bind_property(source, sourceproperty.cstring(), target, targetproperty.cstring(), flags)

  fun bind_property_full(source: Pointer[None] tag, sourceproperty: String, target: Pointer[None] tag, targetproperty: String, flags: I32, transformto: Pointer[None] tag, transformfrom: Pointer[None] tag, userdata: Pointer[None] tag, notify': Pointer[None] tag): GBindingStruct =>
  ...
  fun bind_property_with_closures(source: Pointer[None] tag, sourceproperty: String, target: Pointer[None] tag, targetproperty: String, flags: I32, transformto: GClosureStruct tag, transformfrom: GClosureStruct tag): GBindingStruct =>
