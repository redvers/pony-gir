...
*/
struct GtkApplicationStruct
  embed parent: GApplicationStruct = GApplicationStruct // Typedef
  var priv: GtkApplicationPrivateStruct = GtkApplicationPrivateStruct // PointerType
