...
struct GOutputStreamClass
  ...
  var write_fn: Pointer[None] = Pointer[None] // PointerType
  var splice: Pointer[None] = Pointer[None] // PointerType
  var flush: Pointer[None] = Pointer[None] // PointerType
  var close_fn: Pointer[None] = Pointer[None] // PointerType
  var write_async: Pointer[None] = Pointer[None] // PointerType
  var write_finish: Pointer[None] = Pointer[None] // PointerType
  var splice_async: Pointer[None] = Pointer[None] // PointerType
  var splice_finish: Pointer[None] = Pointer[None] // PointerType
  var flush_async: Pointer[None] = Pointer[None] // PointerType
  var flush_finish: Pointer[None] = Pointer[None] // PointerType
  var close_async: Pointer[None] = Pointer[None] // PointerType
  var close_finish: Pointer[None] = Pointer[None] // PointerType
  var writev_fn: Pointer[None] = Pointer[None] // PointerType
  var writev_async: Pointer[None] = Pointer[None] // PointerType
  var writev_finish: Pointer[None] = Pointer[None] // PointerType
