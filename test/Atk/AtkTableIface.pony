...
struct AtkTableIface
  ...
  var ref_at: Pointer[None] = Pointer[None]
  var get_index_at: Pointer[None] = Pointer[None]
  var get_column_at_index: Pointer[None] = Pointer[None]
  var get_row_at_index: Pointer[None] = Pointer[None]
  var get_n_columns: Pointer[None] = Pointer[None]
  var get_n_rows: Pointer[None] = Pointer[None]
  var get_column_extent_at: Pointer[None] = Pointer[None]
  var get_row_extent_at: Pointer[None] = Pointer[None]
  var get_caption: Pointer[None] = Pointer[None]
  var get_column_description: Pointer[None] = Pointer[None]
  var get_column_header: Pointer[None] = Pointer[None]
  var get_row_description: Pointer[None] = Pointer[None]
  var get_row_header: Pointer[None] = Pointer[None]
  var get_summary: Pointer[None] = Pointer[None]
  var set_caption: Pointer[None] = Pointer[None]
  var set_column_description: Pointer[None] = Pointer[None]
  var set_column_header: Pointer[None] = Pointer[None]
  var set_row_description: Pointer[None] = Pointer[None]
  var set_row_header: Pointer[None] = Pointer[None]
  var set_summary: Pointer[None] = Pointer[None]
  var get_selected_columns: Pointer[None] = Pointer[None]
  var get_selected_rows: Pointer[None] = Pointer[None]
  var is_column_selected: Pointer[None] = Pointer[None]
  var is_row_selected: Pointer[None] = Pointer[None]
  var is_selected: Pointer[None] = Pointer[None]
  var add_row_selection: Pointer[None] = Pointer[None]
  var remove_row_selection: Pointer[None] = Pointer[None]
  var add_column_selection: Pointer[None] = Pointer[None]
  var remove_column_selection: Pointer[None] = Pointer[None]
  var row_inserted: Pointer[None] = Pointer[None]
  var column_inserted: Pointer[None] = Pointer[None]
  var row_deleted: Pointer[None] = Pointer[None]
  var column_deleted: Pointer[None] = Pointer[None]
  var row_reordered: Pointer[None] = Pointer[None]
  var column_reordered: Pointer[None] = Pointer[None]
  var model_changed: Pointer[None] = Pointer[None]
