...
*/
struct GAppLaunchContextClassStruct
  embed parent_class: GObjectClassStruct = GObjectClassStruct // Typedef
  var get_display: Pointer[None] = Pointer[None] // PointerType
  var get_startup_notify_id: Pointer[None] = Pointer[None] // PointerType
  var launch_failed: Pointer[None] = Pointer[None] // PointerType
  var launched: Pointer[None] = Pointer[None] // PointerType
