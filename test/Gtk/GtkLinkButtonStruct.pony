...
*/
struct GtkLinkButtonStruct
  embed parent_instance: GtkButtonStruct = GtkButtonStruct // Typedef
  var priv: GtkLinkButtonPrivateStruct = GtkLinkButtonPrivateStruct // PointerType
