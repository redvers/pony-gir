...
*/
struct GtkColorChooserWidgetStruct
  embed parent_instance: GtkBoxStruct = GtkBoxStruct // Typedef
  var priv: GtkColorChooserWidgetPrivateStruct = GtkColorChooserWidgetPrivateStruct // PointerType
