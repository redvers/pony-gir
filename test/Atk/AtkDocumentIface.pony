...
struct AtkDocumentIface
  ...
  var get_document_type: Pointer[None] = Pointer[None] // PointerType
  var get_document: Pointer[None] = Pointer[None] // PointerType
  var get_document_locale: Pointer[None] = Pointer[None] // PointerType
  var get_document_attributes: Pointer[None] = Pointer[None] // PointerType
  var get_document_attribute_value: Pointer[None] = Pointer[None] // PointerType
  var set_document_attribute: Pointer[None] = Pointer[None] // PointerType
  var get_current_page_number: Pointer[None] = Pointer[None] // PointerType
  var get_page_count: Pointer[None] = Pointer[None] // PointerType
