...
struct GVolumeMonitorClass
  ...
  var volume_added: Pointer[None] = Pointer[None]
  var volume_removed: Pointer[None] = Pointer[None]
  var volume_changed: Pointer[None] = Pointer[None]
  var mount_added: Pointer[None] = Pointer[None]
  var mount_removed: Pointer[None] = Pointer[None]
  var mount_pre_unmount: Pointer[None] = Pointer[None]
  var mount_changed: Pointer[None] = Pointer[None]
  var drive_connected: Pointer[None] = Pointer[None]
  var drive_disconnected: Pointer[None] = Pointer[None]
  var drive_changed: Pointer[None] = Pointer[None]
  var is_supported: Pointer[None] = Pointer[None]
  var get_connected_drives: Pointer[None] = Pointer[None]
  var get_volumes: Pointer[None] = Pointer[None]
  var get_mounts: Pointer[None] = Pointer[None]
  var get_volume_for_uuid: Pointer[None] = Pointer[None]
  var get_mount_for_uuid: Pointer[None] = Pointer[None]
  var adopt_orphan_mount: Pointer[None] = Pointer[None]
  var drive_eject_button: Pointer[None] = Pointer[None]
  var drive_stop_button: Pointer[None] = Pointer[None]
